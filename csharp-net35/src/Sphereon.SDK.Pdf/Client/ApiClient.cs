...
namespace Sphereon.SDK.Pdf.Client
{
    ...
    public partial class ApiClient
    {
        ...
        /// with default configuration and base path (https://gw.api.cloud.sphereon.com/pdf/1.1).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("https://gw.api.cloud.sphereon.com/pdf/1.1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://gw.api.cloud.sphereon.com/pdf/1.1).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://gw.api.cloud.sphereon.com/pdf/1.1")
        {
