...
namespace Sphereon.SDK.Pdf.Model
{
    ...
    public partial class ConversionJobResponse :  IEquatable<ConversionJobResponse>
    {
        ...
        /// <param name="InputLocations">The storage locations of the input files. (required).</param>
        /// <param name="ResultLocations">The storage locations of the result files. (required).</param>
        /// <param name="Job">Job.</param>
        /// <param name="ResultLocationUrls">The storage location URL&#39;s of the result files..</param>
        public ConversionJobResponse(List<string> Inputs = null, List<ConversionTask> ConversionTasks = null, string JobId = null, List<StreamLocation> InputLocations = null, List<StreamLocation> ResultLocations = null, ConversionJob Job = null, List<string> ResultLocationUrls = null)
        {
            ...
            // to ensure "InputLocations" is required (not null)
            if (InputLocations == null)
            {
                throw new InvalidDataException("InputLocations is a required property for ConversionJobResponse and cannot be null");
            }
            else
            {
                this.InputLocations = InputLocations;
            }
            // to ensure "ResultLocations" is required (not null)
            if (ResultLocations == null)
            {
                throw new InvalidDataException("ResultLocations is a required property for ConversionJobResponse and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The storage locations of the input files.</value>
        [DataMember(Name="inputLocations", EmitDefaultValue=false)]
        public List<StreamLocation> InputLocations { get; set; }
        /// <summary>
        /// The storage locations of the result files.
        /// </summary>
        /// <value>The storage locations of the result files.</value>
        [DataMember(Name="resultLocations", EmitDefaultValue=false)]
        public List<StreamLocation> ResultLocations { get; set; }
        /// <summary>
        /// Gets or Sets Job
        /// </summary>
        ...
        /// </summary>
        /// <value>The storage location URL&#39;s of the result files.</value>
        [DataMember(Name="resultLocationUrls", EmitDefaultValue=false)]
        public List<string> ResultLocationUrls { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InputLocations: ").Append(InputLocations).Append("\n");
            sb.Append("  ResultLocations: ").Append(ResultLocations).Append("\n");
            sb.Append("  Job: ").Append(Job).Append("\n");
            sb.Append("  ResultLocationUrls: ").Append(ResultLocationUrls).Append("\n");
        ...
        public bool Equals(ConversionJobResponse other)
        {
            ...
            return 
                ...
                (
                    this.InputLocations == other.InputLocations ||
                    this.InputLocations != null &&
                    this.InputLocations.SequenceEqual(other.InputLocations)
                ) && 
                (
                    this.ResultLocations == other.ResultLocations ||
                    this.ResultLocations != null &&
                    this.ResultLocations.SequenceEqual(other.ResultLocations)
                ) && 
                (
                    this.Job == other.Job ||
                    this.Job != null &&
                ...
                (
                    this.ResultLocationUrls == other.ResultLocationUrls ||
                    this.ResultLocationUrls != null &&
                    this.ResultLocationUrls.SequenceEqual(other.ResultLocationUrls)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InputLocations != null)
                    hash = hash * 59 + this.InputLocations.GetHashCode();
                if (this.ResultLocations != null)
                    hash = hash * 59 + this.ResultLocations.GetHashCode();
                if (this.Job != null)
                    hash = hash * 59 + this.Job.GetHashCode();
                if (this.ResultLocationUrls != null)
                    hash = hash * 59 + this.ResultLocationUrls.GetHashCode();
                if (this.Status != null)
