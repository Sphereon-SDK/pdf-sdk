...
namespace Sphereon.SDK.Pdf.Api
{
    ...
    public partial class ConversionPDFApi : IConversionPDFApi
    {
        ...
        public ApiResponse< PDFJobResponse > DeleteJobWithHttpInfo (string jobid)
        {
            ...
            var localVarPath = "/pdf/0.3.1/conversion2pdf/{jobid}";
        ...
        public ApiResponse< PDFJobResponse > GetJobsWithHttpInfo (List<string> status = null)
        {
            ...
            var localVarPath = "/pdf/0.3.1/conversion2pdf";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< byte[] > GetStreamWithHttpInfo (string jobid)
        {
            ...
            var localVarPath = "/pdf/0.3.1/conversion2pdf/{jobid}/stream";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="stream">The additional binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>PDFJobResponse</returns>
        public PDFJobResponse UploadAdditionalFile (string jobid, System.IO.Stream stream)
        {
             ApiResponse<PDFJobResponse> localVarResponse = UploadAdditionalFileWithHttpInfo(jobid, stream);
             return localVarResponse.Data;
        }
        ...
        /// <param name="stream">The additional binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>ApiResponse of PDFJobResponse</returns>
        public ApiResponse< PDFJobResponse > UploadAdditionalFileWithHttpInfo (string jobid, System.IO.Stream stream)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
        ...
        /// <param name="stream">The additional binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>Task of PDFJobResponse</returns>
        public async System.Threading.Tasks.Task<PDFJobResponse> UploadAdditionalFileAsync (string jobid, System.IO.Stream stream)
        {
             ApiResponse<PDFJobResponse> localVarResponse = await UploadAdditionalFileAsyncWithHttpInfo(jobid, stream);
             return localVarResponse.Data;
        ...
        /// <param name="stream">The additional binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>Task of ApiResponse (PDFJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PDFJobResponse>> UploadAdditionalFileAsyncWithHttpInfo (string jobid, System.IO.Stream stream)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ConversionPDFApi->UploadAdditionalFile");
        ...
        {
             ApiResponse<PDFJobResponse> localVarResponse = UploadFileWithHttpInfo(stream);
             return localVarResponse.Data;
        }
        ...
        {
             ApiResponse<PDFJobResponse> localVarResponse = await UploadFileAsyncWithHttpInfo(stream);
             return localVarResponse.Data;
