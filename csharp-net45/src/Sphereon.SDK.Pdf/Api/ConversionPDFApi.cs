...
namespace Sphereon.SDK.Pdf.Api
{
    ...
    public interface IConversionPDFApi : IApiAccessor
    {
        ...
        ApiResponse<ConversionJobResponse> AddInputFileWithHttpInfo (string jobid, System.IO.Stream stream);
        /// <summary>
        ...
        /// <exception cref="Sphereon.SDK.Pdf.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="jobid">jobid</param>
        /// <param name="inputStreamLocations">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>ConversionJobResponse</returns>
        ...
        /// <param name="inputStreamLocations">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>ApiResponse of ConversionJobResponse</returns>
        ApiResponse<ConversionJobResponse> AddInputStreamLocationsWithHttpInfo (string jobid, List<StreamLocation> inputStreamLocations);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Sphereon.SDK.Pdf.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="settings">Optional settings to use for this job (optional)</param>
        /// <returns>ConversionJobResponse</returns>
        ...
        /// <param name="settings">Optional settings to use for this job (optional)</param>
        /// <returns>ApiResponse of ConversionJobResponse</returns>
        ApiResponse<ConversionJobResponse> CreateJobWithHttpInfo (ConversionSettings settings = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ConversionJobResponse> AddInputFileAsync (string jobid, System.IO.Stream stream);
        ...
        System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> AddInputFileAsyncWithHttpInfo (string jobid, System.IO.Stream stream);
        /// <summary>
        /// Add Input Stream Location(s)
        /// </summary>
        /// <remarks>
        ...
        /// <param name="inputStreamLocations">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>Task of ConversionJobResponse</returns>
        System.Threading.Tasks.Task<ConversionJobResponse> AddInputStreamLocationsAsync (string jobid, List<StreamLocation> inputStreamLocations);
        ...
        /// <param name="inputStreamLocations">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> AddInputStreamLocationsAsyncWithHttpInfo (string jobid, List<StreamLocation> inputStreamLocations);
        /// <summary>
        /// Create a PDF conversion job
        /// </summary>
        /// <remarks>
        ...
        /// <param name="settings">Optional settings to use for this job (optional)</param>
        /// <returns>Task of ConversionJobResponse</returns>
        System.Threading.Tasks.Task<ConversionJobResponse> CreateJobAsync (ConversionSettings settings = null);
        ...
        /// <param name="settings">Optional settings to use for this job (optional)</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> CreateJobAsyncWithHttpInfo (ConversionSettings settings = null);
        /// <summary>
        /// Delete a job manually
        /// </summary>
        /// <remarks>
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ConversionJobResponse</returns>
        System.Threading.Tasks.Task<ConversionJobResponse> DeleteJobAsync (string jobid);
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> DeleteJobAsyncWithHttpInfo (string jobid);
        /// <summary>
        /// Job definition and state
        /// </summary>
        /// <remarks>
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ConversionJobResponse</returns>
        System.Threading.Tasks.Task<ConversionJobResponse> GetJobAsync (string jobid);
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> GetJobAsyncWithHttpInfo (string jobid);
        /// <summary>
        /// Get all jobs
        /// </summary>
        /// <remarks>
        ...
        /// <param name="status">A list of status to filter on. (optional)</param>
        /// <returns>Task of ConversionJobResponse</returns>
        System.Threading.Tasks.Task<ConversionJobResponse> GetJobsAsync (List<string> status = null);
        ...
        /// <param name="status">A list of status to filter on. (optional)</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> GetJobsAsyncWithHttpInfo (List<string> status = null);
        /// <summary>
        /// Get the current result stream
        /// </summary>
        /// <remarks>
        ...
        /// <param name="job">jobEntity</param>
        /// <returns>Task of ConversionJobResponse</returns>
        System.Threading.Tasks.Task<ConversionJobResponse> SubmitJobAsync (string jobid, ConversionJob job);
        ...
        /// <param name="job">jobEntity</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> SubmitJobAsyncWithHttpInfo (string jobid, ConversionJob job);
    ...
    public partial class ConversionPDFApi : IConversionPDFApi
    {
        ...
        /// <summary>
        /// Upload a file Upload an image, office or pdf for conversion to PDF. Please note that you can upload multiple files. Conversion will not be started yet.
        /// </summary>
        /// <exception cref="Sphereon.SDK.Pdf.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="jobid">jobid</param>
        /// <param name="stream">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>ConversionJobResponse</returns>
        public ConversionJobResponse AddInputFile (string jobid, System.IO.Stream stream)
        {
             ApiResponse<ConversionJobResponse> localVarResponse = AddInputFileWithHttpInfo(jobid, stream);
        ...
        /// <param name="stream">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>ApiResponse of ConversionJobResponse</returns>
        public ApiResponse< ConversionJobResponse > AddInputFileWithHttpInfo (string jobid, System.IO.Stream stream)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ConversionPDFApi->AddInputFile");
            // verify the required parameter 'stream' is set
            if (stream == null)
                throw new ApiException(400, "Missing required parameter 'stream' when calling ConversionPDFApi->AddInputFile");

            var localVarPath = "/conversion2pdf/jobs/{jobid}/streams/multipart";
            ...
            {
                Exception exception = ExceptionFactory("AddInputFile", localVarResponse);
        ...
        /// <param name="stream">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>Task of ConversionJobResponse</returns>
        public async System.Threading.Tasks.Task<ConversionJobResponse> AddInputFileAsync (string jobid, System.IO.Stream stream)
        {
             ApiResponse<ConversionJobResponse> localVarResponse = await AddInputFileAsyncWithHttpInfo(jobid, stream);
             return localVarResponse.Data;
        ...
        /// <param name="stream">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> AddInputFileAsyncWithHttpInfo (string jobid, System.IO.Stream stream)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ConversionPDFApi->AddInputFile");
        ...
        /// <summary>
        /// Add Input Stream Location(s) Add image, office or pdf input stream location(s) from the storage API for conversion to PDF. Please note that you can upload multiple files. Conversion will not be started yet.
        /// </summary>
        /// <exception cref="Sphereon.SDK.Pdf.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="jobid">jobid</param>
        /// <param name="inputStreamLocations">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>ConversionJobResponse</returns>
        public ConversionJobResponse AddInputStreamLocations (string jobid, List<StreamLocation> inputStreamLocations)
        {
             ApiResponse<ConversionJobResponse> localVarResponse = AddInputStreamLocationsWithHttpInfo(jobid, inputStreamLocations);
             return localVarResponse.Data;
        }
        ...
        /// <param name="inputStreamLocations">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>ApiResponse of ConversionJobResponse</returns>
        public ApiResponse< ConversionJobResponse > AddInputStreamLocationsWithHttpInfo (string jobid, List<StreamLocation> inputStreamLocations)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ConversionPDFApi->AddInputStreamLocations");
            // verify the required parameter 'inputStreamLocations' is set
            if (inputStreamLocations == null)
                throw new ApiException(400, "Missing required parameter 'inputStreamLocations' when calling ConversionPDFApi->AddInputStreamLocations");

            var localVarPath = "/conversion2pdf/jobs/{jobid}/streams/location";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            localVarPathParams.Add("format", "json");
            if (jobid != null) localVarPathParams.Add("jobid", Configuration.ApiClient.ParameterToString(jobid)); // path parameter
            if (inputStreamLocations != null && inputStreamLocations.GetType() != typeof(byte[]))
            {
                localVarPostBody = Configuration.ApiClient.Serialize(inputStreamLocations); // http body (model) parameter
            }
            else
            {
                localVarPostBody = inputStreamLocations; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("AddInputStreamLocations", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="inputStreamLocations">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>Task of ConversionJobResponse</returns>
        public async System.Threading.Tasks.Task<ConversionJobResponse> AddInputStreamLocationsAsync (string jobid, List<StreamLocation> inputStreamLocations)
        {
             ApiResponse<ConversionJobResponse> localVarResponse = await AddInputStreamLocationsAsyncWithHttpInfo(jobid, inputStreamLocations);
             return localVarResponse.Data;
        ...
        /// <param name="inputStreamLocations">The (additional) binary image or PDF (file/inputstream) to convert to PDF</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> AddInputStreamLocationsAsyncWithHttpInfo (string jobid, List<StreamLocation> inputStreamLocations)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ConversionPDFApi->AddInputStreamLocations");
        ...
        /// <summary>
        /// Create a PDF conversion job Create a PDF conversion job using optional settings supplied, otherwise defaults will be used
        /// </summary>
        /// <exception cref="Sphereon.SDK.Pdf.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="settings">Optional settings to use for this job (optional)</param>
        /// <returns>ConversionJobResponse</returns>
        public ConversionJobResponse CreateJob (ConversionSettings settings = null)
        {
             ApiResponse<ConversionJobResponse> localVarResponse = CreateJobWithHttpInfo(settings);
             return localVarResponse.Data;
        }
        ...
        /// <param name="settings">Optional settings to use for this job (optional)</param>
        /// <returns>ApiResponse of ConversionJobResponse</returns>
        public ApiResponse< ConversionJobResponse > CreateJobWithHttpInfo (ConversionSettings settings = null)
        {

            var localVarPath = "/conversion2pdf/jobs";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="settings">Optional settings to use for this job (optional)</param>
        /// <returns>Task of ConversionJobResponse</returns>
        public async System.Threading.Tasks.Task<ConversionJobResponse> CreateJobAsync (ConversionSettings settings = null)
        {
             ApiResponse<ConversionJobResponse> localVarResponse = await CreateJobAsyncWithHttpInfo(settings);
             return localVarResponse.Data;
        ...
        /// <param name="settings">Optional settings to use for this job (optional)</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> CreateJobAsyncWithHttpInfo (ConversionSettings settings = null)
        {
        ...
        public ApiResponse< ConversionJobResponse > DeleteJobWithHttpInfo (string jobid)
        {
            ...
            var localVarPath = "/conversion2pdf/jobs/{jobid}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ConversionJobResponse</returns>
        public async System.Threading.Tasks.Task<ConversionJobResponse> DeleteJobAsync (string jobid)
        {
             ApiResponse<ConversionJobResponse> localVarResponse = await DeleteJobAsyncWithHttpInfo(jobid);
             return localVarResponse.Data;
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> DeleteJobAsyncWithHttpInfo (string jobid)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ConversionPDFApi->DeleteJob");
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ConversionJobResponse</returns>
        public async System.Threading.Tasks.Task<ConversionJobResponse> GetJobAsync (string jobid)
        {
             ApiResponse<ConversionJobResponse> localVarResponse = await GetJobAsyncWithHttpInfo(jobid);
             return localVarResponse.Data;
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> GetJobAsyncWithHttpInfo (string jobid)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ConversionPDFApi->GetJob");
        ...
        /// <param name="status">A list of status to filter on. (optional)</param>
        /// <returns>Task of ConversionJobResponse</returns>
        public async System.Threading.Tasks.Task<ConversionJobResponse> GetJobsAsync (List<string> status = null)
        {
             ApiResponse<ConversionJobResponse> localVarResponse = await GetJobsAsyncWithHttpInfo(status);
             return localVarResponse.Data;
        ...
        /// <param name="status">A list of status to filter on. (optional)</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> GetJobsAsyncWithHttpInfo (List<string> status = null)
        {
        ...
        public ApiResponse< byte[] > GetStreamWithHttpInfo (string jobid)
        {
            ...
            var localVarPath = "/conversion2pdf/jobs/{jobid}/streams/result";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="job">jobEntity</param>
        /// <returns>Task of ConversionJobResponse</returns>
        public async System.Threading.Tasks.Task<ConversionJobResponse> SubmitJobAsync (string jobid, ConversionJob job)
        {
             ApiResponse<ConversionJobResponse> localVarResponse = await SubmitJobAsyncWithHttpInfo(jobid, job);
             return localVarResponse.Data;
        ...
        /// <param name="job">jobEntity</param>
        /// <returns>Task of ApiResponse (ConversionJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ConversionJobResponse>> SubmitJobAsyncWithHttpInfo (string jobid, ConversionJob job)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ConversionPDFApi->SubmitJob");
