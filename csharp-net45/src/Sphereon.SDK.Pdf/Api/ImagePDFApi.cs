...
namespace Sphereon.SDK.Pdf.Api
{
    ...
    /// </summary>
    public interface IImagePDFApi : IApiAccessor
    {
        ...
        ApiResponse<PDFJobResponse> DeleteJobWithHttpInfo (string jobid);
        /// <summary>
        ...
        ApiResponse<string> GetStreamWithHttpInfo (string jobid);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Sphereon.SDK.Pdf.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="stream">The binary image (file/inputstream) to convert to PDF</param>
        /// <returns>PDFJobResponse</returns>
        ...
        System.Threading.Tasks.Task<PDFJobResponse> DeleteJobAsync (string jobid);
        ...
        System.Threading.Tasks.Task<ApiResponse<PDFJobResponse>> DeleteJobAsyncWithHttpInfo (string jobid);
        /// <summary>
        /// Job definition and state
        /// </summary>
        /// <remarks>
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of PDFJobResponse</returns>
        System.Threading.Tasks.Task<PDFJobResponse> GetJobAsync (string jobid);
        ...
        System.Threading.Tasks.Task<string> GetStreamAsync (string jobid);
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> GetStreamAsyncWithHttpInfo (string jobid);
        /// <summary>
        /// Submit PDF job for processing
        /// </summary>
        /// <remarks>
        ...
        /// <param name="job">jobEntity</param>
        /// <returns>Task of PDFJobResponse</returns>
        System.Threading.Tasks.Task<PDFJobResponse> SubmitJobAsync (string jobid, PDFJob job);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ImagePDFApi : IImagePDFApi
    {
        private Sphereon.SDK.Pdf.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ImagePDFApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ImagePDFApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ImagePDFApi(Configuration configuration = null)
        {
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>PDFJobResponse</returns>
        public PDFJobResponse DeleteJob (string jobid)
        {
             ApiResponse<PDFJobResponse> localVarResponse = DeleteJobWithHttpInfo(jobid);
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>ApiResponse of PDFJobResponse</returns>
        public ApiResponse< PDFJobResponse > DeleteJobWithHttpInfo (string jobid)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ImagePDFApi->DeleteJob");

            var localVarPath = "/image2pdf/{jobid}";
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of PDFJobResponse</returns>
        public async System.Threading.Tasks.Task<PDFJobResponse> DeleteJobAsync (string jobid)
        {
             ApiResponse<PDFJobResponse> localVarResponse = await DeleteJobAsyncWithHttpInfo(jobid);
             return localVarResponse.Data;
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ApiResponse (PDFJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PDFJobResponse>> DeleteJobAsyncWithHttpInfo (string jobid)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ImagePDFApi->DeleteJob");
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>PDFJobResponse</returns>
        public PDFJobResponse GetJob (string jobid)
        {
             ApiResponse<PDFJobResponse> localVarResponse = GetJobWithHttpInfo(jobid);
             return localVarResponse.Data;
        }
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>ApiResponse of PDFJobResponse</returns>
        public ApiResponse< PDFJobResponse > GetJobWithHttpInfo (string jobid)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ImagePDFApi->GetJob");
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of PDFJobResponse</returns>
        public async System.Threading.Tasks.Task<PDFJobResponse> GetJobAsync (string jobid)
        {
             ApiResponse<PDFJobResponse> localVarResponse = await GetJobAsyncWithHttpInfo(jobid);
             return localVarResponse.Data;
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ApiResponse (PDFJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PDFJobResponse>> GetJobAsyncWithHttpInfo (string jobid)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ImagePDFApi->GetJob");
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>string</returns>
        public string GetStream (string jobid)
        {
             ApiResponse<string> localVarResponse = GetStreamWithHttpInfo(jobid);
             return localVarResponse.Data;
        }
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse< string > GetStreamWithHttpInfo (string jobid)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ImagePDFApi->GetStream");

            var localVarPath = "/image2pdf/{jobid}/stream";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> GetStreamAsync (string jobid)
        {
             ApiResponse<string> localVarResponse = await GetStreamAsyncWithHttpInfo(jobid);
             return localVarResponse.Data;
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> GetStreamAsyncWithHttpInfo (string jobid)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ImagePDFApi->GetStream");
        ...
        /// <param name="job">jobEntity</param>
        /// <returns>PDFJobResponse</returns>
        public PDFJobResponse SubmitJob (string jobid, PDFJob job)
        {
             ApiResponse<PDFJobResponse> localVarResponse = SubmitJobWithHttpInfo(jobid, job);
             return localVarResponse.Data;
        }
        ...
        /// <param name="job">jobEntity</param>
        /// <returns>ApiResponse of PDFJobResponse</returns>
        public ApiResponse< PDFJobResponse > SubmitJobWithHttpInfo (string jobid, PDFJob job)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ImagePDFApi->SubmitJob");
            // verify the required parameter 'job' is set
            if (job == null)
                throw new ApiException(400, "Missing required parameter 'job' when calling ImagePDFApi->SubmitJob");
        ...
        /// <param name="job">jobEntity</param>
        /// <returns>Task of PDFJobResponse</returns>
        public async System.Threading.Tasks.Task<PDFJobResponse> SubmitJobAsync (string jobid, PDFJob job)
        {
             ApiResponse<PDFJobResponse> localVarResponse = await SubmitJobAsyncWithHttpInfo(jobid, job);
             return localVarResponse.Data;
        ...
        /// <param name="job">jobEntity</param>
        /// <returns>Task of ApiResponse (PDFJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PDFJobResponse>> SubmitJobAsyncWithHttpInfo (string jobid, PDFJob job)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling ImagePDFApi->SubmitJob");
        ...
        {
             ApiResponse<PDFJobResponse> localVarResponse = UploadImageWithHttpInfo(stream);
             return localVarResponse.Data;
        }
        ...
        public ApiResponse< PDFJobResponse > UploadImageWithHttpInfo (System.IO.Stream stream)
        {
            ...
            if (stream == null)
                throw new ApiException(400, "Missing required parameter 'stream' when calling ImagePDFApi->UploadImage");

            var localVarPath = "/image2pdf";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        {
             ApiResponse<PDFJobResponse> localVarResponse = await UploadImageAsyncWithHttpInfo(stream);
             return localVarResponse.Data;
