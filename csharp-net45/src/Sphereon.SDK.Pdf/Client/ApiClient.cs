...
namespace Sphereon.SDK.Pdf.Client
{
    ...
    public partial class ApiClient
    {
        ...
        /// with default configuration and base path (https://localhost:18082/).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("https://localhost:18082/");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://localhost:18082/).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://localhost:18082/")
        {
