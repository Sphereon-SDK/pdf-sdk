...
namespace Sphereon.SDK.Pdf.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversionJobResponse :  IEquatable<ConversionJobResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ConversionJobResponse(ResultResponse Result = default(ResultResponse), InputResponse Input = default(InputResponse), string JobId = default(string), List<ConversionTask> ConversionTasks = default(List<ConversionTask>), ConversionJob Job = default(ConversionJob))
        {
            this.Result = Result;
            this.Input = Input;
            this.JobId = JobId;
