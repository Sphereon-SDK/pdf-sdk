...
namespace Sphereon.SDK.Pdf.Model
{
    ...
    public partial class ConversionSettings :  IEquatable<ConversionSettings>
    {
        ...
        /// <param name="Ocr">Whether to perform OCR. When set to false the text in the PDF will not be searchable. Not applicable to Office input files!.</param>
        public ConversionSettings(Lifecycle Lifecycle = null, int? QualityFactor = null, string ResultFileName = null, EngineEnum? Engine = null, Compression Compression = null, VersionEnum? Version = null, bool? Ocr = null)
        {
        ...
        /// </summary>
        /// <value>Whether to perform OCR. When set to false the text in the PDF will not be searchable. Not applicable to Office input files!</value>
