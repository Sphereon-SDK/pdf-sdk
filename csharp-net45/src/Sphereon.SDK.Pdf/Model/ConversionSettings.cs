...
namespace Sphereon.SDK.Pdf.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversionSettings :  IEquatable<ConversionSettings>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Engine
        /// </summary>
        ...
        {
            // QualityFactor (int?) maximum
            if(this.QualityFactor > (int?)10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for QualityFactor, must be a value less than or equal to 10.", new [] { "QualityFactor" });
            }

            // QualityFactor (int?) minimum
            if(this.QualityFactor < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for QualityFactor, must be a value greater than or equal to 0.", new [] { "QualityFactor" });
            }
