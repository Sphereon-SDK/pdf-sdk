...
namespace Sphereon.SDK.Pdf.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversionTaskInput :  IEquatable<ConversionTaskInput>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversionTaskInput" /> class.
        /// </summary>
        /// <param name="StreamLocations">Input Stream Locations.</param>
        public ConversionTaskInput(List<StreamLocation> StreamLocations = null)
        {
        ...
        /// </summary>
        /// <value>Input Stream Locations</value>
        [DataMember(Name="streamLocations", EmitDefaultValue=false)]
        public List<StreamLocation> StreamLocations { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConversionTaskInput {\n");
            sb.Append("  StreamLocations: ").Append(StreamLocations).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversionTaskInput);
        }

        /// <summary>
        /// Returns true if ConversionTaskInput instances are equal
        /// </summary>
        /// <param name="other">Instance of ConversionTaskInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversionTaskInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.StreamLocations == other.StreamLocations ||
                    this.StreamLocations != null &&
                    this.StreamLocations.SequenceEqual(other.StreamLocations)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StreamLocations != null)
                    hash = hash * 59 + this.StreamLocations.GetHashCode();
                return hash;
            }
        }
    }
