...
namespace Sphereon.SDK.Pdf.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InputResponse :  IEquatable<InputResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InputResponse" /> class.
        /// </summary>
        /// <param name="StreamLocations">Input Stream Locations.</param>
        public InputResponse(List<StreamLocation> StreamLocations = null)
        {
        ...
        /// </summary>
        /// <param name="other">Instance of InputResponse to be compared</param>
        /// <returns>Boolean</returns>
