...
namespace Sphereon.SDK.Pdf.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PDFJob :  IEquatable<PDFJob>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PDFJob" /> class.
        /// </summary>
        ...
        public PDFJob(string JobId = null, Image2PDFSettings Settings = null)
        {
            // to ensure "JobId" is required (not null)
            if (JobId == null)
            {
                throw new InvalidDataException("JobId is a required property for PDFJob and cannot be null");
            }
            else
            {
                this.JobId = JobId;
        ...
        public Image2PDFSettings Settings { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PDFJob);
        }

        /// <summary>
        /// Returns true if PDFJob instances are equal
        /// </summary>
        /// <param name="other">Instance of PDFJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PDFJob other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
