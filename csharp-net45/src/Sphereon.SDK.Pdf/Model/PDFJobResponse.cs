...
namespace Sphereon.SDK.Pdf.Model
{
    ...
    public partial class PDFJobResponse :  IEquatable<PDFJobResponse>
    {
        ...
        public PDFJobResponse(string JobId = null, List<string> Inputs = null, List<ConversionTask> ConversionTasks = null, PDFJob Job = null)
        {
            // to ensure "Inputs" is required (not null)
            if (Inputs == null)
            {
                throw new InvalidDataException("Inputs is a required property for PDFJobResponse and cannot be null");
            }
            else
            {
                this.Inputs = Inputs;
