...
public class ConversionPDFApi {
    ...
    private com.squareup.okhttp.Call addInputFileCall(String jobid, File stream, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/conversion2pdf/jobs/{jobid}/streams/multipart".replaceAll("\\{format\\}","json")
     ...
     */
    public ConversionJobResponse addInputFile(String jobid, File stream) throws ApiException {
        ApiResponse<ConversionJobResponse> resp = addInputFileWithHttpInfo(jobid, stream);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ConversionJobResponse> addInputFileWithHttpInfo(String jobid, File stream) throws ApiException {
        com.squareup.okhttp.Call call = addInputFileCall(jobid, stream, null, null);
     ...
     */
    public com.squareup.okhttp.Call addInputFileAsync(String jobid, File stream, final ApiCallback<ConversionJobResponse> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call addInputStreamLocationsCall(String jobid, List<StreamLocation> inputStreamLocations, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = inputStreamLocations;
        ...
        if (inputStreamLocations == null) {
            throw new ApiException("Missing the required parameter 'inputStreamLocations' when calling addInputStreamLocations(Async)");
        }
        

        // create path and map variables
        String localVarPath = "/conversion2pdf/jobs/{jobid}/streams/location".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "jobid" + "\\}", apiClient.escapeString(jobid.toString()));
     ...
     * @param jobid jobid (required)
     * @param inputStreamLocations The (additional) binary image or PDF (file/inputstream) to convert to PDF (required)
     * @return ConversionJobResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ConversionJobResponse addInputStreamLocations(String jobid, List<StreamLocation> inputStreamLocations) throws ApiException {
        ApiResponse<ConversionJobResponse> resp = addInputStreamLocationsWithHttpInfo(jobid, inputStreamLocations);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ConversionJobResponse> addInputStreamLocationsWithHttpInfo(String jobid, List<StreamLocation> inputStreamLocations) throws ApiException {
        com.squareup.okhttp.Call call = addInputStreamLocationsCall(jobid, inputStreamLocations, null, null);
        Type localVarReturnType = new TypeToken<ConversionJobResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call addInputStreamLocationsAsync(String jobid, List<StreamLocation> inputStreamLocations, final ApiCallback<ConversionJobResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addInputStreamLocationsCall(jobid, inputStreamLocations, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ConversionJobResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for createJob */
    private com.squareup.okhttp.Call createJobCall(ConversionSettings settings, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = settings;
        

        // create path and map variables
        String localVarPath = "/conversion2pdf/jobs".replaceAll("\\{format\\}","json");
     ...
     * @param settings Optional settings to use for this job (optional)
     * @return ConversionJobResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ConversionJobResponse createJob(ConversionSettings settings) throws ApiException {
        ApiResponse<ConversionJobResponse> resp = createJobWithHttpInfo(settings);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ConversionJobResponse> createJobWithHttpInfo(ConversionSettings settings) throws ApiException {
        com.squareup.okhttp.Call call = createJobCall(settings, null, null);
        Type localVarReturnType = new TypeToken<ConversionJobResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create a PDF conversion job (asynchronously)
     * Create a PDF conversion job using optional settings supplied, otherwise defaults will be used
     * @param settings Optional settings to use for this job (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createJobAsync(ConversionSettings settings, final ApiCallback<ConversionJobResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createJobCall(settings, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ConversionJobResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call deleteJobCall(String jobid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/conversion2pdf/jobs/{jobid}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "jobid" + "\\}", apiClient.escapeString(jobid.toString()));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ConversionJobResponse deleteJob(String jobid) throws ApiException {
        ApiResponse<ConversionJobResponse> resp = deleteJobWithHttpInfo(jobid);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ConversionJobResponse> deleteJobWithHttpInfo(String jobid) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteJobAsync(String jobid, final ApiCallback<ConversionJobResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ConversionJobResponse getJob(String jobid) throws ApiException {
        ApiResponse<ConversionJobResponse> resp = getJobWithHttpInfo(jobid);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ConversionJobResponse> getJobWithHttpInfo(String jobid) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getJobAsync(String jobid, final ApiCallback<ConversionJobResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ConversionJobResponse getJobs(List<String> status) throws ApiException {
        ApiResponse<ConversionJobResponse> resp = getJobsWithHttpInfo(status);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ConversionJobResponse> getJobsWithHttpInfo(List<String> status) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getJobsAsync(List<String> status, final ApiCallback<ConversionJobResponse> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call getStreamCall(String jobid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/conversion2pdf/jobs/{jobid}/streams/result".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "jobid" + "\\}", apiClient.escapeString(jobid.toString()));
    ...
    private com.squareup.okhttp.Call submitJobCall(String jobid, ConversionJob job, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ConversionJobResponse submitJob(String jobid, ConversionJob job) throws ApiException {
        ApiResponse<ConversionJobResponse> resp = submitJobWithHttpInfo(jobid, job);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ConversionJobResponse> submitJobWithHttpInfo(String jobid, ConversionJob job) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call submitJobAsync(String jobid, ConversionJob job, final ApiCallback<ConversionJobResponse> callback) throws ApiException {
