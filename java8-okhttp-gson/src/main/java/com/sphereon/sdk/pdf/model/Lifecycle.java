...
public class Lifecycle   {
  ...
  public enum ApplicableJobStatussesEnum {
    ...
    ApplicableJobStatussesEnum(String value) {
      this.value = value;
    }
  ...
  @SerializedName("applicableJobStatusses")
  private List<ApplicableJobStatussesEnum> applicableJobStatusses = new ArrayList<ApplicableJobStatussesEnum>();
  ...
  public Lifecycle applicableJobStatusses(List<ApplicableJobStatussesEnum> applicableJobStatusses) {
    this.applicableJobStatusses = applicableJobStatusses;
    return this;
  }

  public Lifecycle addApplicableJobStatussesItem(ApplicableJobStatussesEnum applicableJobStatussesItem) {
    this.applicableJobStatusses.add(applicableJobStatussesItem);
    return this;
  }

   /**
   * Job status needs to be in this list in order for the action to be performeld!
   * @return applicableJobStatusses
  **/
  @ApiModelProperty(example = "null", value = "Job status needs to be in this list in order for the action to be performeld!")
  public List<ApplicableJobStatussesEnum> getApplicableJobStatusses() {
    return applicableJobStatusses;
  }

  public void setApplicableJobStatusses(List<ApplicableJobStatussesEnum> applicableJobStatusses) {
    this.applicableJobStatusses = applicableJobStatusses;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.applicableJobStatusses, lifecycle.applicableJobStatusses) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicableJobStatusses, action, type);
  }
  ...
  public String toString() {
    ...
    sb.append("    applicableJobStatusses: ").append(toIndentedString(applicableJobStatusses)).append("\n");
