...
import com.sphereon.sdk.pdf.api.util.CsvTifXmlSetupAndPdfAssert;
...
public class AdvCsvTifXmlConversion2PDFApiTest extends Conversion2PDFApiTest {

    private final boolean WRITE_TO_FILE = true;
    private SetupAndPdfAssert setUpAndPdfAssert = new CsvTifXmlSetupAndPdfAssert();
