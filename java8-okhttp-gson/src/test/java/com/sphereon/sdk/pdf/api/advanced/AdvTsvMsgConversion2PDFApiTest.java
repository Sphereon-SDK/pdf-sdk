...
import com.sphereon.sdk.pdf.api.util.TsvMsgSetupAndPdfAssert;
...
public class AdvTsvMsgConversion2PDFApiTest extends Conversion2PDFApiTest {

    private final boolean WRITE_TO_FILE = true;
    private SetupAndPdfAssert setUpAndPdfAssert = new TsvMsgSetupAndPdfAssert();
