...
import com.sphereon.sdk.pdf.api.util.DocJpgDwgSetupAndPdfAssert;
...
public class PreDocJpgDwgConversion2PDFApiTest extends Conversion2PDFApiTest {

    private final boolean WRITE_TO_FILE = true;
    private SetupAndPdfAssert setUpAndPdfAssert = new DocJpgDwgSetupAndPdfAssert();
