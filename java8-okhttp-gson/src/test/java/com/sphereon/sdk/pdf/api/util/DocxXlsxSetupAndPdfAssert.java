...
public class DocxXlsxSetupAndPdfAssert implements SetupAndPdfAssert {
    ...
    public List<Conversion2PDFApiTest.FileUploadConfig> getUploadConfigs() {
        uploadConfigs.add(new Conversion2PDFApiTest.FileUploadConfig("11Sheets.xlsx",Conversion2PDFApiTest.class.getResource("/11Sheets.xlsx")));
        uploadConfigs.add(new Conversion2PDFApiTest.FileUploadConfig(2, "4Pages.docx", Conversion2PDFApiTest.class.getResource("/4Pages.docx")));
