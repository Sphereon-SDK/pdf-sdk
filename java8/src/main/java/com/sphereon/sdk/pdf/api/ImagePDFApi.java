...
public class ImagePDFApi {
    ...
    public ImagePDFApi(ApiClient apiClient) {
    ...
    private com.squareup.okhttp.Call deleteJobCall(String jobid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/image2pdf/{jobid}".replaceAll("\\{format\\}","json")
    ...
    private com.squareup.okhttp.Call getStreamCall(String jobid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/image2pdf/{jobid}/stream".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "jobid" + "\\}", apiClient.escapeString(jobid.toString()));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public String getStream(String jobid) throws ApiException {
        ApiResponse<String> resp = getStreamWithHttpInfo(jobid);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> getStreamWithHttpInfo(String jobid) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getStreamAsync(String jobid, final ApiCallback<String> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call uploadImageCall(File stream, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (stream == null) {
            throw new ApiException("Missing the required parameter 'stream' when calling uploadImage(Async)");
        }
        

        // create path and map variables
        String localVarPath = "/image2pdf".replaceAll("\\{format\\}","json");
     ...
     * @param stream The binary image (file/inputstream) to convert to PDF (required)
     * @return PDFJobResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PDFJobResponse uploadImage(File stream) throws ApiException {
        ApiResponse<PDFJobResponse> resp = uploadImageWithHttpInfo(stream);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PDFJobResponse> uploadImageWithHttpInfo(File stream) throws ApiException {
        com.squareup.okhttp.Call call = uploadImageCall(stream, null, null);
        Type localVarReturnType = new TypeToken<PDFJobResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call uploadImageAsync(File stream, final ApiCallback<PDFJobResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = uploadImageCall(stream, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PDFJobResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
