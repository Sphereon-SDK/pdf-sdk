...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pdf.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://gw.api.cloud.sphereon.com/pdf/1.1
     */
    this.basePath = 'https://gw.api.cloud.sphereon.com/pdf/1.1'.replace(/\/+$/, '');
