...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConversionTaskInput'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConversionTaskInput'));
  } else {
    // Browser globals (root is window)
    if (!root.Pdf) {
      root.Pdf = {};
    }
    root.Pdf.ConversionTask = factory(root.Pdf.ApiClient, root.Pdf.ConversionTaskInput);
  }
}(this, function(ApiClient, ConversionTaskInput) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('conversionInput')) {
        obj['conversionInput'] = ConversionTaskInput.constructFromObject(data['conversionInput']);
      }
   ...
   * @member {module:model/ConversionTask.EngineEnum} engine
   */
  exports.prototype['engine'] = undefined;
  /**
   * Conversion input
   * @member {module:model/ConversionTaskInput} conversionInput
   */
  exports.prototype['conversionInput'] = undefined;
  /**
   ...
   * @member {module:model/ConversionTask.StatusEnum} status
   */
