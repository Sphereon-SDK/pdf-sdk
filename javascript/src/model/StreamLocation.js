...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pdf.StreamLocation = factory(root.Pdf.ApiClient);
  }
  ...
  /**
   * The fully resolved path of the file, folder and container. This path corresponds with the /streams/path endpoints. This value is automatically determined
