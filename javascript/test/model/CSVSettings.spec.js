...
(function(root, factory) {
  ...
  describe('CSVSettings', function() {
    it('should create an instance of CSVSettings', function() {
      // uncomment below and update the code to test CSVSettings
      //var instane = new Pdf.CSVSettings();
      //expect(instance).to.be.a(Pdf.CSVSettings);
    });

    it('should have the property separatorCharacter (base name: "separatorCharacter")', function() {
      // uncomment below and update the code to test the property separatorCharacter
      //var instane = new Pdf.CSVSettings();
      //expect(instance).to.be();
    });

    it('should have the property standardRowHeight (base name: "standardRowHeight")', function() {
      // uncomment below and update the code to test the property standardRowHeight
      //var instane = new Pdf.CSVSettings();
      //expect(instance).to.be();
    });

    it('should have the property standardColumnWidth (base name: "standardColumnWidth")', function() {
      // uncomment below and update the code to test the property standardColumnWidth
      //var instane = new Pdf.CSVSettings();
      //expect(instance).to.be();
    });
