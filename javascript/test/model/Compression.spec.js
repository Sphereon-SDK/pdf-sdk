...
(function(root, factory) {
  ...
  describe('Compression', function() {
    it('should create an instance of Compression', function() {
      // uncomment below and update the code to test Compression
      //var instane = new Pdf.Compression();
      //expect(instance).to.be.a(Pdf.Compression);
    });
