...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pdf.ConversionJob();
  });
  ...
  describe('ConversionJob', function() {
    it('should create an instance of ConversionJob', function() {
      // uncomment below and update the code to test ConversionJob
      //var instane = new Pdf.ConversionJob();
      //expect(instance).to.be.a(Pdf.ConversionJob);
    });
