...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pdf.ConversionJobResponse();
  });
  ...
  describe('ConversionJobResponse', function() {
    it('should create an instance of ConversionJobResponse', function() {
      // uncomment below and update the code to test ConversionJobResponse
      //var instane = new Pdf.ConversionJobResponse();
      //expect(instance).to.be.a(Pdf.ConversionJobResponse);
    });
