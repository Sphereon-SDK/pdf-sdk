...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pdf.ConversionSettings();
  });
  ...
  describe('ConversionSettings', function() {
    it('should create an instance of ConversionSettings', function() {
      // uncomment below and update the code to test ConversionSettings
      //var instane = new Pdf.ConversionSettings();
      //expect(instance).to.be.a(Pdf.ConversionSettings);
    });

    it('should have the property qualityFactor (base name: "qualityFactor")', function() {
      // uncomment below and update the code to test the property qualityFactor
      //var instane = new Pdf.ConversionSettings();
    ...
    it('should have the property containerConversion (base name: "containerConversion")', function() {
      // uncomment below and update the code to test the property containerConversion
      //var instane = new Pdf.ConversionSettings();
      //expect(instance).to.be();
    });
    ...
    it('should have the property jobLifecycle (base name: "jobLifecycle")', function() {
      // uncomment below and update the code to test the property jobLifecycle
      //var instane = new Pdf.ConversionSettings();
      //expect(instance).to.be();
    });
