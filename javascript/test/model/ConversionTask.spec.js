...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pdf.ConversionTask();
  });
  ...
  describe('ConversionTask', function() {
    it('should create an instance of ConversionTask', function() {
      ...
      //var instane = new Pdf.ConversionTask();
      //expect(instance).to.be.a(Pdf.ConversionTask);
    });
    ...
    it('should have the property conversionInput (base name: "conversionInput")', function() {
      // uncomment below and update the code to test the property conversionInput
      //var instane = new Pdf.ConversionTask();
      //expect(instance).to.be();
    });
