...
(function(root, factory) {
  ...
  describe('Lifecycle', function() {
    it('should create an instance of Lifecycle', function() {
      ...
      //var instane = new Pdf.Lifecycle();
      //expect(instance).to.be.a(Pdf.Lifecycle);
    });

    it('should have the property applicableJobStatusses (base name: "applicableJobStatusses")', function() {
      // uncomment below and update the code to test the property applicableJobStatusses
      //var instane = new Pdf.Lifecycle();
