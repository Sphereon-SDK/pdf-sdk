...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pdf.ResultSettings();
  });
  ...
  describe('ResultSettings', function() {
    it('should create an instance of ResultSettings', function() {
      // uncomment below and update the code to test ResultSettings
      //var instane = new Pdf.ResultSettings();
      //expect(instance).to.be.a(Pdf.ResultSettings);
    });
